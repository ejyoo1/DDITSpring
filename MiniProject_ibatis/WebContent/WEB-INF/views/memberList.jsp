			       				...
			       				<div class="card-body">
			       					<div class="row">
						                ...
						                <ul class="nav nav-pills ml-auto p-2">
						                  <li class="nav-item"><a class="nav-link btn-sm">Tab 1</a></li>
						                  <li class="nav-item"><a class="nav-link btn-sm">Tab 2</a></li>
						                  <li class="nav-item"><a class="nav-link btn-sm">Tab 3</a></li>
						                  <li class="nav-item dropdown">
						                    <a class="nav-link dropdown-toggle btn-sm" data-toggle="dropdown" href="#">
